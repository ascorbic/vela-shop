...
export type HomepageQuery = { __typename?: 'Query', allShopifyProduct: { __typename?: 'ShopifyProductConnection', nodes: Array<{ __typename?: 'ShopifyProduct', storefrontId: string, handle: string, title: string, featuredImage?: { __typename?: 'ShopifyImage', originalSrc: string, altText?: string | null } | null }> } };
